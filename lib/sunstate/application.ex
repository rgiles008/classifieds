defmodule Sunstate.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Sunstate.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    SunstateWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
